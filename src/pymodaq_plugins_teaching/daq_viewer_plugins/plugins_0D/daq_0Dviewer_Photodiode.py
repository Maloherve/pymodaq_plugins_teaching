...
class DAQ_0DViewer_Photodiode(DAQ_Viewer_base):
    ...
    def ini_detector(self, controller=None):
        ...
        # self.dte_signal_temp.emit(DataToExport(name='Teaching',
    ...
    def grab_data(self, Naverage=1, **kwargs):
        ...
        monochrom_power = self.controller.grab_monochromator()

        data_list.append( DataFromPlugins(name="Monochromator Power", data=monochrom_power, dim="Data0D", labels=["Mono Power"]) )

        self.dte_signal.emit(DataToExport(name='Spectrometer', data= data_list ) )
